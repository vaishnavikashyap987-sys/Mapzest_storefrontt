            ...
            {isOpen && (
                <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4">
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-md bg-white border border-slate-200 rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden p-5 sm:p-8"
                    >
                        <button
                            onClick={onClose}
                        ...
                        {error && (
                            <motion.div
                                ...
                                className="bg-red-500/10 border border-red-500/20 rounded-lg sm:rounded-xl p-2.5 sm:p-3 mb-4 sm:mb-6 text-red-650 text-xs sm:text-sm text-center"
                            >
                                {error}
                            </motion.div>
                        )}
                        ...
                        <form onSubmit={handleEmailLogin} className="space-y-4">
                            <div className="space-y-1 sm:space-y-2">
                                <label className="text-xs sm:text-sm text-slate-655 font-medium ml-1">Email Address</label>
                            ...
                            <div className="space-y-1 sm:space-y-2">
                                <div className="flex justify-between items-center ml-1">
                                    <label className="text-xs sm:text-sm text-slate-655 font-medium">Password</label>
                                    <Link to="/forgot-password" onClick={onClose} className="text-[10px] sm:text-xs text-accent-cyan hover:text-cyan-700 transition-colors">
                                        Forgot password?
                                    </Link>
                                </div>
                                <div className="relative group/input">
