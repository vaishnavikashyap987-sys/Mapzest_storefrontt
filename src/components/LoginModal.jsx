            ...
            {isOpen && (
                <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4">
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-md bg-[#0a0a0a] border border-white/10 rounded-3xl shadow-2xl overflow-hidden p-8"
                    >
                        <button
                            onClick={onClose}
                            className="absolute top-4 right-4 p-2 text-gray-500 hover:text-white transition-colors hover:bg-white/10 rounded-lg z-10"
                        >
                            <X size={20} />
                        </button>
                        ...
                        <form onSubmit={handleEmailLogin} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between items-center ml-1">
                                    ...
                                    <Link to="/forgot-password" onClick={onClose} className="text-xs text-accent-cyan hover:text-white transition-colors">
                                        Forgot password?
                                    </Link>
                                </div>
                                <div className="relative group/input">
                        ...
                        <div className="mt-6 text-center text-sm text-gray-400">
                            ...
                            <button onClick={onSwitchToRegister} className="text-accent-cyan hover:text-white transition-colors font-medium">
                                Create free account
                            </button>
                        </div>
                    </motion.div>
