...
const MyConsole = () => {
    ...
    const cardStyle = "backdrop-blur-xl bg-white border border-slate-200 rounded-3xl p-6 shadow-md relative overflow-hidden group hover:border-slate-300 transition-colors";
    ...
    return (
        <div className="min-h-screen pt-24 pb-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative">
            ...
            <motion.header
                ...
                className="mb-10 text-center sm:text-left relative overflow-hidden rounded-3xl bg-white border border-slate-200 shadow-md p-8 sm:p-12"
            >
                <div className="absolute top-0 right-0 w-2/3 h-full bg-gradient-to-l from-accent-cyan/5 via-accent-purple/5 to-transparent pointer-events-none blur-3xl" />
                <div className="relative z-10 flex flex-col gap-2">
                    <span className="text-accent-cyan font-medium tracking-wide uppercase text-sm">Dashboard</span>
                    <h1 className="text-4xl sm:text-5xl font-bold text-slate-900 tracking-tight">
                        Hello, <span className="text-transparent bg-clip-text bg-gradient-to-r from-slate-900 to-slate-500">{user?.displayName?.split(' ')[0] || 'Explorer'}</span>
                    </h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div className="lg:col-span-1 space-y-6">
                        ...
                        {['overview', 'platforms', 'data', 'plans'].map((tab) => (
                            <button
                                ...
                                className={`flex items-center gap-3 px-5 py-4 rounded-2xl transition-all font-medium border ${activeTab === tab
                                    ? 'bg-gradient-to-r from-accent-cyan/10 to-transparent text-accent-cyan border-accent-cyan/20'
                    ...
                    <div className={`${cardStyle} hidden lg:block`}>
                        ...
                        <div className="flex items-center gap-2 mb-4 text-slate-800 relative z-10">
                            <div className="p-2 bg-slate-100 rounded-lg text-slate-500">
                                <HardDrive className="w-4 h-4" />
                            </div>
                            <span className="text-sm font-bold">Storage Quota</span>
                        </div>
                        <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden mb-3 relative z-10">
                            <motion.div
                                initial={{ width: 0 }}
                        ...
                        <div className="flex justify-between text-xs text-slate-500 relative z-10 font-mono">
                ...
                <div className="lg:col-span-3 space-y-8">
                        ...
                        <>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div className={cardStyle}>
                                    <div className="flex items-center gap-5">
                                        <div className="p-4 bg-slate-50 rounded-2xl text-slate-500 ring-1 ring-inset ring-slate-200">
                                            <Activity className="w-8 h-8" />
                                        </div>
                                        <div>
                                            <h3 className="text-slate-500 text-sm font-medium mb-1">Active Platforms</h3>
                                            <p className="text-3xl font-bold text-slate-900">{platforms.filter(p => p.type !== 'Add-on' && checkOwnership(userSubscriptions, p.id)).length}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className={cardStyle}>
                                    <div className="flex items-center gap-5">
                                        ...
                                        <div>
                                            <h3 className="text-slate-500 text-sm font-medium mb-1">Total Files</h3>
                                ...
                                <div className={cardStyle}>
                                    <div className="flex items-center gap-5">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xl font-bold text-slate-900 truncate max-w-[140px]" title={checkOwnership(userSubscriptions, 'mapzest-pro') ? 'Mapzest Pro' : checkOwnership(userSubscriptions, 'p_urban_analytics') ? 'Mapzest Go' : 'Free Tier'}>
                            ...
                            <div className={`${cardStyle} lg:hidden`}>
                                <div className="flex items-center gap-4 mb-2">
                                    ...
                                    <div>
                                        <h3 className="text-slate-500 text-sm">Storage</h3>
                                        <p className="text-2xl font-bold text-slate-900">{validUsedPercent}%</p>
                                    </div>
                                </div>
                            </div>
                        </>
                        ...
                        >
                            <div className="flex items-center justify-between mb-6 px-2">
                                ...
                                <div className="flex gap-3">
                                    <label className={`cursor-pointer text-sm font-bold text-white bg-accent-cyan hover:bg-cyan-700 px-4 py-2 rounded-lg transition-colors flex items-center gap-2 ${isUploading ? 'opacity-50 pointer-events-none' : ''}`}>
                                        {isUploading ? (
                                            <>
                                    ...
                                    <button className="text-sm font-medium text-accent-cyan hover:text-cyan-700 transition-colors bg-cyan-50 hover:bg-cyan-100 px-4 py-2 rounded-lg">View All</button>
                                </div>
                            </div>

                            <div className="backdrop-blur-xl bg-white border border-slate-200 rounded-2xl overflow-hidden flex flex-col shadow-sm">
                                    ...
                                    <table className="w-full text-left border-collapse">
                                        ...
                                        <tbody className="divide-y divide-slate-200">
                                            {files.length === 0 ? (
                                                ...
                                                files.map((file) => (
                                                    <tr key={file.id} className="hover:bg-slate-55 transition-colors group">
                                                        <td className="p-4">
                                                            <div className="flex items-center gap-3">
                                                                <div className="p-2 rounded-lg bg-slate-100 text-slate-500">
                                                                    {file.type === 'vector' ? <Activity size={16} /> : <Database size={16} />}
                                                                </div>
                                                                <span className="text-slate-700 font-medium group-hover:text-slate-900 transition-colors">{file.name}</span>
                                                            </div>
                                                        </td>
                                                        <td className="p-4 text-slate-500 text-sm capitalize">{file.type}</td>
                                                        <td className="p-4 text-slate-500 font-mono text-sm">{file.file_size_mb} MB</td>
                                                        <td className="p-4 text-slate-500 text-sm">{new Date(file.created_at).toLocaleDateString()}</td>
                                                        <td className="p-4 text-right">
                                                            <div className="flex justify-end gap-2">
                                                                <button
                                                                    className="h-8 w-8 flex items-center justify-center bg-slate-50 text-slate-500 border border-slate-200 rounded-lg hover:bg-slate-100 hover:text-slate-800 transition-colors"
                                                                ...
                                                                <button
                                                                    ...
                                                                    className="h-8 w-8 flex items-center justify-center bg-slate-50 text-slate-500 border border-slate-200 rounded-lg hover:bg-red-50 hover:text-red-650 hover:border-red-200 transition-colors"
                                                                    title="Delete File"
                                                                >
                                                                    <Trash2 size={14} />
                                                                </button>
                                ...
                                >
                                    ...
                                    <div className="flex gap-3 justify-end">
                                        <button
                                            ...
                                            className="px-4 py-2 rounded-lg text-slate-500 hover:text-slate-700 hover:bg-slate-100 transition-colors"
                                        >
                                            Cancel
                                        </button>
                                        <button
                                            onClick={handleDeleteFile}
                                            className="px-4 py-2 rounded-lg bg-red-655 hover:bg-red-700 text-white font-medium transition-colors"
                                        >
                                            Delete Forever
                                        </button>
                                    </div>
                    ...
                    {(activeTab === 'overview' || activeTab === 'platforms') && (
                        ...
                        >
                            <div className="flex items-center justify-between mb-6 px-2">
                                ...
                                <button onClick={() => setActiveTab('plans')} className="text-sm font-medium text-slate-500 hover:text-slate-800 transition-colors">Manage Subscriptions</button>
                            </div>
                            <div className="backdrop-blur-xl bg-white border border-slate-200 rounded-2xl overflow-hidden flex flex-col shadow-sm">
                                <div className="overflow-x-auto">
                                    <table className="w-full text-left border-collapse">
                                        <thead className="bg-slate-50 border-b border-slate-200">
                                            <tr>
                                                ...
                                                <th className="p-4 text-xs font-bold text-slate-500 uppercase tracking-wider hidden md:table-cell">Description</th>
                                            ...
                                            {platforms.filter(p => p.type !== 'Add-on' && checkOwnership(userSubscriptions, p.id)).length === 0 ? (
                                                <tr>
                                                    <td colSpan="4" className="py-12 text-center">
                                                        ...
                                                        <h3 className="text-lg font-medium text-slate-700">No Active Platforms</h3>
                                                        <p className="text-slate-500 mb-6">Explore our plans to unlock powerful tools.</p>
                                                        <button onClick={() => setActiveTab('plans')} className="px-6 py-2 bg-accent-cyan text-white font-bold rounded-xl hover:bg-cyan-700 transition-colors">
                                                            View Plans
                                                        </button>
                                                    </td>
                                                </tr>
                                                ...
                                                platforms.filter(p => p.type !== 'Add-on' && checkOwnership(userSubscriptions, p.id)).map((platform) => {
                                                    ...
                                                    return (
                                                        <tr key={platform.id} className="hover:bg-slate-50 transition-colors group">
                                                            <td className="p-4">
                                                                <div className="flex items-center gap-3">
                                                                    <div className="p-2 rounded-lg bg-slate-100 text-slate-500">
                                                            ...
                                                            <td className="p-4 hidden md:table-cell">
                                                                <p className="text-sm text-slate-500 truncate max-w-[250px]" title={platform.description}>{platform.description}</p>
                                                            </td>
                                                            <td className="p-4">
                                                                <span className="px-2 py-1 rounded text-[10px] font-bold uppercase tracking-wider bg-green-50 text-green-700 border border-green-200 flex items-center gap-1 w-fit">
                                                                ...
                                                                <div className="flex justify-end gap-2">
                                                                    {platform.id === 'p_urban_analytics' && !isProOwned && (
                                                                        <button
                                                                            ...
                                                                            className="h-9 px-4 bg-purple-50 text-purple-700 border border-purple-200 rounded-lg text-xs font-bold hover:bg-purple-100 transition-all flex items-center justify-center whitespace-nowrap"
                                                                        >
                                                                            Upgrade Pro
                                                                        </button>
                                                                    )}
                                                                    <button
                                                                        ...
                                                                        className="h-9 px-4 bg-slate-50 text-slate-600 border border-slate-200 rounded-lg text-xs font-bold hover:bg-slate-100 hover:text-slate-900 transition-colors flex items-center gap-2 whitespace-nowrap"
                                                                    >
                    ...
                    {activeTab === 'plans' && (
                        ...
                        >
                            ...
                            <div className="backdrop-blur-xl bg-white border border-slate-200 rounded-2xl overflow-hidden flex flex-col max-h-[600px] shadow-sm">
                                <div className="overflow-y-auto custom-scrollbar flex-1">
                                    <table className="w-full text-left border-collapse">
                                        <thead className="bg-slate-50 sticky top-0 z-10 backdrop-blur-md border-b border-slate-200">
                                            <tr>
                                                <th className="p-4 text-xs font-bold text-slate-500 uppercase tracking-wider">Application</th>
                                                <th className="p-4 text-xs font-bold text-slate-500 uppercase tracking-wider hidden md:table-cell">Description</th>
                                                <th className="p-4 text-xs font-bold text-slate-500 uppercase tracking-wider">Current Plan</th>
                                                <th className="p-4 text-xs font-bold text-slate-500 uppercase tracking-wider text-right">Action</th>
                                            </tr>
                                        </thead>
                                        <tbody className="divide-y divide-slate-200">
                                            {APPLICATIONS.map((app) => {
                                                ...
                                                return (
                                                    <tr key={app.id} className="hover:bg-slate-50 transition-colors group">
                                                        ...
                                                        <td className="p-4 hidden md:table-cell">
                                                            <p className="text-sm text-slate-500 truncate max-w-[250px]" title={app.desc}>{app.desc}</p>
                                                        </td>
                                                        <td className="p-4">
                                                        ...
                                                        <td className="p-4 text-right">
                                                            <button
                                                                ...
                                                                className="px-3 py-1.5 rounded-lg border border-slate-200 text-slate-600 text-xs font-medium hover:text-slate-900 hover:bg-slate-100 transition-colors"
                                                            >
                                                                Configure
                                                            </button>
                                                        </td>
    ...
    return createPortal(
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
            ...
            <motion.div
                ...
                className="relative bg-white border border-slate-200 rounded-3xl p-8 max-w-4xl w-full shadow-2xl overflow-hidden max-h-[85vh] flex flex-col"
            >
                <div className="flex justify-between items-start mb-6">
                    <div>
                        <h3 className="text-2xl font-bold text-slate-900 mb-2">Configure {app.name}</h3>
                        <p className="text-slate-500">{app.desc}</p>
                    </div>
                    <button onClick={onClose} className="p-2 text-slate-400 hover:text-slate-700 bg-slate-100 rounded-full hover:bg-slate-200 transition-colors">
                        <X className="w-5 h-5" />
                    </button>
                </div>
                    ...
                    {app.plans.map((plan) => {
                        ...
                        return (
                            <div key={plan.id} className={`relative flex flex-col p-6 rounded-2xl border transition-all ${isOwned
                                ...
                                : 'bg-slate-50/50 border-slate-200 hover:border-slate-300 shadow-sm'
                                }`}>
                                {isOwned && (
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="flex items-baseline gap-1 mt-1">
                                        ...
                                        <span className="text-sm text-slate-500">/{plan.renewal === 'Monthly' ? 'mo' : ''}</span>
                                    </div>
                                </div>
                                ...
                                <ul className="space-y-3 mb-8 flex-1">
                                    {plan.features?.map((feature, i) => (
                                        <li key={i} className="flex items-center gap-2 text-sm text-slate-600">
                                            ...
                                            <li className="text-sm text-slate-400 italic">Standard features included</li>
                                        )}
                                </ul>
                                ...
                                <button
                                    ...
                                    className={`w-full py-2.5 rounded-xl font-bold text-sm transition-all ${isOwned
                                        ...
                                        : 'bg-slate-100 text-slate-800 border border-slate-200 hover:bg-slate-200 hover:scale-[1.02]'
                                        }`}
                                >
    ...
    return createPortal(
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
            ...
            <motion.div
                ...
                className="relative bg-white border border-slate-200 rounded-3xl p-8 max-w-md w-full shadow-2xl overflow-hidden"
            >
                {/* Close Button */}
                <button
                    onClick={onClose}
                    className="absolute top-4 right-4 p-2 text-slate-400 hover:text-slate-700 bg-slate-100 rounded-full hover:bg-slate-200 transition-colors"
                >
                    <X className="w-5 h-5" />
                </button>

                <div className="flex flex-col items-center text-center">
                    <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-slate-100 to-slate-200 p-[1px] mb-6">
                    ...
                    <p className="text-slate-500 mb-6">
                        Self-service payments for <span className="text-slate-900 font-bold">{platform.name}</span> are currently paused as we upgrade our billing system.
                    </p>

                    <div className="w-full bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6 text-sm text-amber-800">
                        Please contact our sales team to manually activate this plan for your account.
                    </div>

                    <button
                        onClick={onContact}
                        className="w-full py-3.5 rounded-xl font-bold text-white bg-gradient-to-r from-accent-cyan to-[#0099FF] shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/40 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2"
                    >
                        Contact Sales
                    </button>
                </div>
